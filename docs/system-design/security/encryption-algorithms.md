...
- 哈希值长度更长：例如 SHA-256 算法的哈希值长度为 256 位，而 MD5 算法的哈希值长度为 128 位，这就提高了攻击者暴力破解或者彩虹表攻击的难度。[SHA-256 Algorithm: What is It and How It Works](https://www.ssl2buy.com/wiki/sha-256-algorithm)
